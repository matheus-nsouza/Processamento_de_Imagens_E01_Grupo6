...
gantt
    ...
    dateFormat  DD-MM
    section Semanas
    Estrutura e Planejamento       :done, s1, 14-10, 1d
    Funcionalidades Principais     :active, s2, 28-10, 1d
    Aprimoramento e Análise        :s3, 04-11, 1d
    Documentação e Vídeo           :s4, 11-11, 1d
    Revisão e Entrega Final        :s5, 18-11, 1d
```
...
```mermaid
graph LR
    A[Introdução<br/>10-15s] --> B[Demonstração<br/>Funcionalidades<br/>2-3min]
    B --> C[Resultados<br/>Comparativos<br/>1-2min]
    C --> D[Conclusão<br/>10-15s]
```
